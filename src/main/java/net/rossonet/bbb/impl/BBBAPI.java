...
/**
 * List of supported API for BigBlueButton, see BigBlueButton doc for more
 * information Based on:
 * https://github.com/sakaicontrib/bbb-tool/blob/master/impl/src/java/org/sakaiproject/bbb/impl/bbbapi/BBBAPI.java
 *
...
public interface BBBAPI {
	...
	/**
	 * Delete a given recording (or a list of recordings whose ids are separated by
	 * commas)
	 *
	 * @return true if the recording is successfully deleted, exception is thrown on
	 *         failure
	 * @throws BBBException
	 */
	 ...
	 *
	 * @return true if the meeting is successfully ended or does not exist, false
	 *         otherwise
	 * @throws BBBException
	 */
	...
	/**
	 * Get the default config xml file from the BBB server and save it to the given
	 * file path
	 *
	...
	/**
	 * Get the url to join the given meeting with the display name and corresponding
	 * role type
	 *
	...
	/**
	 * Get the list of all live meetings in server, every parameter like meetingIDs
	 * can be a list of meetings but separated by commas(e.g., "id1,id2")
	 *
	 * @return a map which has a field named meetings, and the value is the list of
	 *         meeting information
	 * @throws BBBException
	 */
	 ...
	 *
	 * @return a map which has a field named recordings, and the value is the list
	...
	public Map<String, Object> getRecordings(String meetingIDs, String recordIDs, String states,
			Map<String, String> meta) throws BBBException;
	 ...
	 *
	 * @return true if the recording(s) is successfully published/unpublished,
	 ...
	 *
	 * @return true if the recording(s) is successfully updated, exception is thrown
	 *         on failure
	 * @throws BBBException
	 */
